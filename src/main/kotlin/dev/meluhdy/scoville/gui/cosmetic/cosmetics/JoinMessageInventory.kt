...
class JoinMessageInventory(p: Player, prevGUI: MelodiaGUI?) : MelodiaGUI(ScovilleUI.plugin, p, prevGUI), IScovilleGUI {
    ...
    override val melodiaItems: ArrayList<MelodiaGUIItem>
        get() = arrayListOf(
            makeItem(9, "https://textures.minecraft.net/texture/868f4cef949f32e33ec5ae845f9c56983cbe13375a4dec46e5bbfb7dcb6", ConnectionMessages.MR_COOL),
            makeItem(10, "https://textures.minecraft.net/texture/fb59b146cbe49394dcdff3c150a3b6cd3e7bc493ba8db39c5273d6c7c04a15f1", ConnectionMessages.SHAKESPEARE),
            makeItem(11, "https://textures.minecraft.net/texture/45435c37edafe165c92ae3736e15c464ad621d61220435d1a39adb4705fb886", ConnectionMessages.SUPERHERO),
            makeItem(12, "https://textures.minecraft.net/texture/c779b643831f838fb5efd2bafa4c6ea97bb256839761588525498d6294fc47", ConnectionMessages.AVIATION),
            makeItem(13, "https://textures.minecraft.net/texture/9ae81d366634833dbbffc28e41eaa0ae77b0ae1ca53cfea9fbe47f74538ac38", ConnectionMessages.MONARCH),
            ...
            MelodiaGUIItem(
                ...
                PlayerCosmeticsManager.getOrCreate(p).connectionMessage = ConnectionMessages.DEFAULT
                this.initializeItems()
                this.p.updateInventory()
            },
            getBack(18, this)
